...
class Preferences(models.Model):
    ...
    max_height = models.IntegerField(default=244, null=True)
    min_height = models.IntegerField(validators=[MinValueValidator(0)], default=0, null=True)
    min_sex_drive = models.IntegerField(validators=[MinValueValidator(0)], default=0, null=True)
    max_sex_drive = models.IntegerField(validators=[MaxValueValidator(100)], default=100, null=True)
    genders = ArrayField(models.CharField(max_length=200), null=True)
    body_type = ArrayField(models.CharField(max_length=200, choices=body_type_choices, null=True))
    relationship_status = ArrayField(models.CharField(max_length=200, choices=relationship_choices, null=True))
    education = ArrayField(models.CharField(max_length=200, choices=education_choices, null=True))
    religion = ArrayField(models.CharField(max_length=200, choices=religion_choices, null=True))
    race = ArrayField(models.CharField(max_length=200, choices=race_choices, null=True))
